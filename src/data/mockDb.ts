...
export interface MaterialIssue {
  ...
  date: string;
  remarks: string;
  photo?: string; // photo verification
}
...
// Initial mock data with piece-rate (e.g. Sunita earns ₹30 per Valve produced)
const INITIAL_EMPLOYEES: Employee[] = [
  ...
  { id: 'EMP-003', name: 'Sunita Patel', role: 'Worker', department: 'Production Line A', status: 'Active', baseRate: 35, phone: '+91 87654 32109', email: 'sunita@aksales.com', joinedDate: '2025-04-01' }, // ₹35 per unit
  { id: 'EMP-004', name: 'Amit Verma', role: 'Worker', department: 'Production Line B', status: 'Active', baseRate: 30, phone: '+91 76543 21098', email: 'amit@aksales.com', joinedDate: '2025-05-12' },  // ₹30 per unit
  ...
  { id: 'EMP-006', name: 'Vikram Singh', role: 'Worker', department: 'Production Line A', status: 'Active', baseRate: 32, phone: '+91 90123 45678', email: 'vikram@aksales.com', joinedDate: '2025-06-01' }  // ₹32 per unit
];
