...
let returnIndex = code.indexOf('\n  return (\n    <div className="device-container">');
if (returnIndex === -1) {
  returnIndex = code.indexOf('\n  return (\r\n    <div className="device-container">');
}
if (returnIndex === -1) {
  console.error("Could not find return statement properly");
  process.exit(1);
}

const logicPart = code.substring(0, returnIndex + 1); // +1 to include the newline
